          ...
          <a className="change-link" href='#'>Change picture</a> 
                        ...
                        <div className="col-xs-8">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" name="is_multiple_capacity" type="checkbox" value="check" onChange={this.changeCapacityType} checked={this.state.capacity_min!=this.state.capacity_max?"checked":null} />    
                                </div>
                            </div>
                            <div className="form-group">
                    ...
                    <div className="row form-group">
                        ...
                        <QuillEditor changeQuill={this.changeQuill} setValue={last !== undefined?last.content:null}  />
                    </div>
                    <div className="row">
                        <button className="btn btn-primary" type="submit">발행</button>
                    </div>
